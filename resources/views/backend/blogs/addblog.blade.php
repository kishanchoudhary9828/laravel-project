...
<!-- 
          ...
          @endif -->
           ...
           rahukl jhhjhjh   <form action="{{route('storeblogdata')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div>
              <div class="card-body">
              <!-- <div class="form-group"> -->
                 ...
                 <input type="file" id='image' name='image'  onchange="previewMultiple(event)"  multiple >
                 <div id="galeria" class="input-images" style="display:flex; height:90px; width:50px; border-radius: 19px;opacity:85%; padding-top: .5rem;"  >
